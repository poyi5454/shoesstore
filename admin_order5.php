	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
            <h2><img src="images/diagram-60.png" width="48" height="48" /> ข้อมูลการจัดส่งสินค้า</h2>
          </div>
		    <table width="99%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="1%" align="left" valign="middle">&nbsp;</td>
                <td width="99%" height="40" align="left" valign="middle"><form id="form1" name="form1" method="post" action="admin_main.php?m_page=<?=$_GET['m_page']?>" style="margin:10px;">
...
$q="SELECT * FROM ".$order."  WHERE(ord_id LIKE '%".$Search."%'  AND ord_status IN('5')) ORDER BY ord_status DESC";  
		...
		?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="30%" height="30" align="left" valign="middle" bgcolor="#999999" class="sell"><strong style="padding-left: 5px;">รายชื่อผู้สั่งซื้อ</strong></td>
                          <td width="13%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>สถานะ</strong></td>
                          <td width="18%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>วันที่จัดส่งวันที่</strong></td>
                          <td width="12%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>รายละเอียด</strong></td>
...
?>
                        <li>
                          <tr>
                            ...
                            <td width="30%" height="20" align="left" valign="middle" bgcolor="#F0F0F0" class="sell1" style="padding-left: 5px;"><?=$Result['ord_name']?></td>
                            <td width="13%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sell1"><?PHP
// ถ้าสถานะเท่ากับ Y  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($Result['ord_status']=='Y'){
				...
				?></td>
                            <td width="18%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sell1"><?=displaydate($Result['ord_date_money'])?></td>
                            <td width="12%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sell1"> [<a href="print.php?m_page=<?=$_GET['m_page']?>&amp;ID=<?=$Result['ord_id']?>&amp;ord=55">ข้อมูล</a>] </td>
