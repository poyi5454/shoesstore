	...
	<div class="data_center_back">
	  <table width="100%" height="500" border="0" cellpadding="0" cellspacing="0">
        <tr>
 		...
 		<strong>ที่อยู่ร้าน</strong> 158  หมู่10 ต.ท่าขอนยาง อ.เมือง จ.มหาสารคาม <br />
		<strong>ติดต่อผู้ขาย</strong> : E-mail  darknessrock1241@gmail.com<br />
	      <strong>Tel</strong>: 0932453831<br />
	    <strong> ID Line</strong> : mark1241<br />
	      <strong>facebook</strong> : https://www.facebook.com/worapat.ngoendee/<br />
</div>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p></td>
