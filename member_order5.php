	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
              <h2><img src="images/diagram-60.png" width="48" height="48" /> รายงานการจัดส่งสินค้า </h2>
          </div>
...
$q="SELECT * FROM ".$order."  WHERE(ord_id LIKE '%".$Search."%' AND ord_idmb='".$_SESSION['sess_mb_id']."' AND ord_status IN('5') ) ORDER BY ord_status DESC";  
		...
		?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="29%" height="30" align="left" valign="middle" bgcolor="#999999" class="sell"><strong style="padding-left: 5px;">รายชื่อผู้สั่งซื้อ</strong></td>
...
?>
                        <li>
                          <tr>
                            ...
                            <td width="29%" height="20" align="left" valign="middle" bgcolor="#F0F0F0" class="sell1" style="padding-left: 5px;"><?=$Result['ord_name']?></td>
...
// ถ้าสถานะเท่ากับ Y  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($Result['ord_status']=='Y'){
				...
				?></td>
							...
							<a href="print.php?ID=<?=$Result['ord_id']?>&amp;ord=5">ข้อมูล</a></td>
