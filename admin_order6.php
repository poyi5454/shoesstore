	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
            <h2><img src="images/diagram-60.png" width="48" height="48" /> ข้อมูลใบสั่งซื้อ ยกเลิกแล้ว </h2>
          </div>
...
$q="SELECT * FROM ".$order."  WHERE(ord_id LIKE '%".$Search."%'  AND ord_status IN('N')) ORDER BY ord_status DESC";  
		...
		?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="14%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>สถานะ</strong></td>
                          <td width="17%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>รายละเอียด</strong></td>
...
// ถ้าสถานะเท่ากับ Y  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($Result['ord_status']=='Y'){
				...
				?></td>
                            <td width="17%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sell1"> [<a href="print.php?m_page=<?=$_GET['m_page']?>&amp;ID=<?=$Result['ord_id']?>&amp;ord=66">ข้อมูล</a>] </td>
                            <td width="10%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sellright1"> [<a href="del_order.php?m_page=<?=$_GET['m_page']?>&amp;ID_admin=<?=$Result['ord_id']?>" onclick=" return confirm('ยืนยันการลบใบสั่งซื่้อ <?=$code?> ออกจากระบบ')">ลบ</a>] </td>
                          </tr>
                        </li>
                        <?PHP $no++; $i++?>
                        <?php } ?>
