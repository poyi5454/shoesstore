	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
              <h2><img src="images/diagram-60.png" width="48" height="48" /> ข้อมูลใบสั่งซื้อสินค้า </h2>
          </div>
...
<form  method="post" action="addVendor.php" style="margin-top:30px;">

<div style="margin-top:30px;">  

<span align="center"> รหัสบริษัท :</span>
     <input type="text" name="vendor_code" id="vendor_code">

     <span align="center"> วันที่สั่งซื้อ :</span>
  
     <input type="date" name="order_date" id="order_date">
     <br>
     <span align="center">ชื่อบริษัท :</span>
     <input type="text" name="vendor_name" id="vendor_name">
    
     <span align="center">ที่อยู่บริษัท :</span>
     <input type="text" name="vendor_address" id="vendor_address">
 <br>
     <span align="center">เบอร์โทรติดต่อ(บริษัท) :</span>
     <input type="text" name="vendor_tel" id="vendor_tel">

    <span width="50" align="center">ผู้จัด :</span>
    <input type="text" name="admin_name" id="pro_name" value="<?=$rs_emp['mb_name']?>" readonly >
    <!-- <input type="button" name="addvendor" id="addvendor" value="Submit"> -->
    <button type="submit">Submit </button>
    </form>
    <br><br> <br> <br><br> <br>
<!--    
     <span align="center">รหัสสินค้า :</span>
     <input type="text" name="order_no" id="order_no"> -->

     <form id="form1" name="form1" method="post" action=""  > 
       <span align="center">รหัสบริษัท: </span> 
       <select name="v_code" id="v_code">
    <?php  
    $query2 = "SELECT * FROM `vendor` ORDER BY vendor_code asc" or die("Error:" . mysqli_error());
    //3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result .
    $result2 = @mysqli_query($con, $query2);
    //4 . แสดงข้อมูลที่ query ออกมา 
      while($rw = mysqli_fetch_array($result2)) {
      ?> 
           <option value="<?=$rw["vendor_code"]; ?>"><?php  echo $rw["vendor_code"]; ?></option>
        <?php
      }
    ?>
   </select>
     <span align="center">รหัสสินค้า(CODE): </span>
     <input type="text" name="order_code" id="order_code" require >
  <br>
    <span align="center">ชื่อสินค้า :</span>
    <input type="text" name="order_name" id="order_name">

 <span align="center">รายละเอียดสินค้า  :</span>
     <input type="text" name="order_details" id="order_details">
     <br>
    <span align="center">จำนวนสินค้า :</span>
    <input type="text" name="order_qty" id="order_qty">
         <span align="center">ราคา :</span>
     <input type="text" name="order_price" id="order_price">
     <br>
     <span width="50" align="center">ผู้จัดซื้อสินค้า :</span>
    <input type="text" name="pro_name" id="pro_name" value="<?=$rs_emp['mb_name']?>" readonly >
</div>
<br>
  <input type="button" name="addPro" id="addPro" value="ADD">
  <br>
  <br>
</form>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="12%" height="10" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>รหัสใบสั่งซื้อ</strong></td>
                          <td width="25%" height="30" align="left" valign="middle" bgcolor="#999999" class="sell"><strong style="padding-left: 5px;">รายชื่อผู้สั่งซื้อ</strong></td>
                          ...
                          <!-- <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>สถานะ</strong></td> -->
                          <!-- <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>ราคา</strong></td> -->
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>ชื่อบริษัท</strong></td>
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>เบอร์โทรติดต่อ(บริษัท)</strong></td>
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>สินค้า(CODE)</strong></td>
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>ราคา (บริษัท)</strong></td>
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>รายการ</strong></td>
  </tr>
</table>
</div> 
...
$q="SELECT * FROM ".$order."  WHERE(ord_id LIKE '%".$Search."%'  AND ord_status IN('Y', '1', '2', '3', '4', '5', '6', 'N') ) ORDER BY ord_status asc";  
		...
		?>
                      <!-- <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>สถานะ</strong></td>
                          <td width="11%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>ข้อมูล</strong></td>
                          <td width="15%" height="30" align="center" valign="middle" bgcolor="#999999" class="sellright"><strong>  ยกเลิก | ลบ </strong></td>
                        </tr>
                        <?
	}							
...
// ถ้าสถานะเท่ากับ Y  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($Result['ord_status']=='Y'){
				...
				?></td>
				   ...
				   [<a href="cancle_order.php?m_page=<?=$_GET['m_page']?>&ID_admin=<?=$Result['ord_id']?>" onclick=" return confirm('ต้องการยกเลิกใบสั่งซื้อ <?=$code?> ')">ยกเลิก</a> |
					<a href="del_order.php?m_page=<?=$_GET['m_page']?>&ID_admin=<?=$Result['ord_id']?>" onclick=" return confirm('ยืนยันการลบใบสั่งซื่้อ <?=$code?> ออกจากระบบ')">ลบ</a>] 
   </td>
                 </tr>
                        </li>
                        <?PHP $no++; $i++?>
