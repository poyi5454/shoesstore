	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
              <h2><img src="images/diagram-60.png" width="48" height="48" /> รออนุมัติสินค้า </h2>
          </div>
...
$q="SELECT * FROM ".$order."  WHERE(ord_id LIKE '%".$Search."%' AND ord_idmb='".$_SESSION['sess_mb_id']."' AND ord_status IN('2') ) ORDER BY ord_status DESC";  
...
// ถ้าสถานะเท่ากับ Y  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($Result['ord_status']=='Y'){
				...
				?></td>
							...
							[<a href="print.php?ID=<?=$Result['ord_id']?>&amp;ord=3">ข้อมูล</a>]</td>
