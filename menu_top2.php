...
<ul class="Head-Menu" style="margin-left: 50px; font-size: 13px;">
					<li class="Page1" id="limenuHead"><a href="admin_main.php?m_page=1">ข้อมูลใบสั่งซื้อ</a></li>
					<li class="Page2" id="limenuHead"><a href="admin_report1.php?m_page=2"> รายงาน-ขายสินค้า </a></li>
					...
					<li class="Page6" id="limenuHead"><a href="admin_format_ems.php?m_page=3"> รูปแบบจัดส่ง Ems </a></li>
					<li class="Page7" id="limenuHead"><a href="admin_board.php?m_page=3"> เว็บบอร์ด </a></li>
					<li class="Page8" id="limenuHead"><a href="admin_oder.php?m_page=1">สั่งซื้อสินค้า</a></li>
                    <?PHP
